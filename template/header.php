    ...
    <div class="search flex flex-row items-center bg-bleu">
      ...
      <div class="flex flex-row justify-between">
        <form action="/search.php">
          <div class="form">
            <input class="bg-transparent text-white border border-gris p-1 px-2 rounded focus:outline-none" type="text" name="query" id="search"
        ...
        <div class="items-center flex flex-row ml-8 justify-between w-44">
      ...
      <div class="relative inline-block text-left">
        <div>
          <button type="button" class="session inline-flex w-full justify-center rounded-md border bg-white text-bleu px-4 py-2 text-sm font-medium " id="menu-button" aria-expanded="true" aria-haspopup="true">
            <a class="text-bleu" href="/profile.php"><h3><?=$_SESSION['user']->pseudo?></h3></a>
