...
<header class="bg-bleu flex flex-row w-full items-center lg:h-[96px] h-[70px] justify-between">
    <nav class="w-11/12 flex flex-row mx-auto justify-between">
        ...
        <?php if($_SESSION && isset($_SESSION['user'])):?>
            ...
            <div class="burger w-10 h-8 flex flex-col justify-between lg:hidden z-50">
                <div class="w-full h-1 bg-gris rounded-full opacity-50"></div>
                <div class="w-full h-1 bg-gris rounded-full opacity-50"></div>
                <div class="w-full h-1 bg-gris rounded-full opacity-50"></div>
            </div>

            <div class="search hidden lg:flex flex-row items-center bg-bleu">
